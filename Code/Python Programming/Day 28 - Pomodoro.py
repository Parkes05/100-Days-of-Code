...
tomato_image = PhotoImage(file='../Data/tomato_28.png')
canvas.create_image(100, 112, image=tomato_image)
timer_text = canvas.create_text(104, 130, fill='white', text='00:00', font=(FONT_NAME, 30, 'bold'))
canvas.grid(column=1, row=1)

text_label = Label(text='Timer', font=(FONT_NAME, 40, 'bold'), fg=GREEN, bg=YELLOW)
text_label.grid(column=1, row=0)

start_button = Button(text='Start', bg=GREEN, command=start_timer)
